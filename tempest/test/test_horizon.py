...
class TestHorizon(TestCase):
    def test_horizon(self):
        ...
        engines_and_params = [
            ...
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": None}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": None}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": None}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": None}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": None}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": None}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": None}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": None}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": "lexicographic", "solver_name": "z3"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": True, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": True, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": True, "ground_abstract_step": False, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": True, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": "weighted"}),
            ("tempest-opt", {"incremental": False, "sat_before_opt": False, "ground_abstract_step": False, "secondary_objective": "weighted"}),
        ]
